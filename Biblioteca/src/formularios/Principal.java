...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuarioLogin.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if ((usuarioLogin.getText().equals("lyandro")) && (senhaLogin.getText().equals("1234"))) {
            JOptionPane.showMessageDialog(null, "Acesso Garantido!");
            TelaInicial inicial = new TelaInicial();
            inicial.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Acesso negado! Senha ou usuário incorreto!");
        }
